//
// Created by dinhnambkhn on 21. 12. 25..
//
#include <iostream>
...
int main() {
    ...
    //read pose.txt file
    std::ifstream ifs("/home/dinhnambkhn/Desktop/Visual_SLAM_book/Visual_SLAM_tutorial/ch05/rgbd/pose.txt");
    ...
    for (int i = 0; i < poses.size(); i++) {
        ...
        //read colorImg
        colorImg = cv::imread("/home/dinhnambkhn/Desktop/Visual_SLAM_book/Visual_SLAM_tutorial/ch05/rgbd/color/" +
                              std::to_string(i + 1) + ".png");
        //read depthImg
        depthImg = cv::imread("/home/dinhnambkhn/Desktop/Visual_SLAM_book/Visual_SLAM_tutorial/ch05/rgbd/depth/" +
